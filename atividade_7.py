...
if salario <= 280:
    ...
    novo_salario = salario + valor_aumento
    print("O seu salário atual é "+str(salario)+" 15% de aumento. O valor do aumento é "+str(valor_aumento)+" e o novo salario é "+str(novo_salario))
    ...
    novo_salario = salario + valor_aumento
    print("O seu salário atual é "+str(salario)+
          " 5% de aumento. O valor do aumento é "+
          str(valor_aumento)+" e o novo salario é "+str(novo_salario))